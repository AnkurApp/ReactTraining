          ...
          <div className={"flex-container"}>
            <div className={"section-A"}>
              <div className={"text-section"}>
                ...
                <p>
                  Manage your company Bot in few easy steps, join our Pro plan
                  to try a 360* experience of our service.
                </p>
                <p>
                ...
                <div className="ProPlan">
                  ...
                  <div className={"planFeatures"}>
                    ...
                    <p className={"color-white"}>
                      Bot with AI that can recognize the user's behaviour and
                      can automatize the sentences.
                    </p>
                  </div>
